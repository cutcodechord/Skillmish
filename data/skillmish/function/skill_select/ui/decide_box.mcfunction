...
# health_blast
    execute if items block ~ ~ ~ container.3 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run tag @s add skillmish.process.ui_box.box_decided.health_blast_1
    execute if items block ~ ~ ~ container.4 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run tag @s add skillmish.process.ui_box.box_decided.health_blast_2
    execute if items block ~ ~ ~ container.5 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run tag @s add skillmish.process.ui_box.box_decided.health_blast_3
    execute if items block ~ ~ ~ container.3 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run item replace block ~ ~ ~ container.3 with minecraft:air
    execute if items block ~ ~ ~ container.4 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run item replace block ~ ~ ~ container.4 with minecraft:air
    execute if items block ~ ~ ~ container.5 minecraft:name_tag[minecraft:custom_data={"skillmish.skill.item.health_blast":true}] run item replace block ~ ~ ~ container.5 with minecraft:air
